    ...
    <section className="bg-white py-8 md:py-12 border-b border-slate-100">
      <div className="container mx-auto px-4 md:px-6 max-w-4xl space-y-6 md:space-y-8 text-center">
        <p className="text-base md:text-lg text-slate-700">
          Of het nu gaat om een verhuizing of verbouwing, of een renovatieproject aan de buitenkant van uw woning: wij nemen de tijd
          om uw wensen te bespreken en leveren strak, duurzaam schilderwerk met garantie.
        </p>
